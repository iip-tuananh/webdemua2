                ...
                <div >
                    <div class="section">
                        ...
                        <div class="os-header-heading">
                            ...
                            Cảm ơn bạn đã mua hàng! Vui lòng chuyển khoản thanh toán đơn hàng để hoàn tất đơn hàng.
                            </span>
                        </div>
                        </div>
                    </div>
                        ...
                        <div class="content-box">
                            ...
                            <div class="content-box-row content-box-row-padding">
                                <div class="section-content">
                                    ...
                                    <p>
                                        Chuyển khoản ngân hàng (Tự động xác nhận giao dịch)
                                    </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="section thank-you-checkout-info">
                        ...
                        <div class="content-box">
                            <div class="content-box-row content-box-row-padding content-box-row-no-border">
                                <h2>Hướng dẫn thanh toán chuyển khoản</h2>
                            </div>
                            <div class="content-box-row content-box-row-padding">
                                <div class="section-content">
                                    <div class="section-content-column">
