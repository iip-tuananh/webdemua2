...
<div ng-controller="LoginClientController" ng-cloak>
    <section style="padding: 80px 0; background: linear-gradient(0deg, rgba(0,0,0,0), rgba(0,0,0,0)),  url(/site/images/bg_footer.jpg?1721988795194) center no-repeat;">
        <div class="container">
                                        ...
                                        <form id="customer_login">
                                            <div class="form-signup clearfix">
                                                ...
                                                <div class="btn_boz_khac">
                                                    <div class="btn_khac">
                                                        <span class="quenmk" style="font-size: 16px; line-height: 24px; cursor: pointer; float: left;" ng-click="showFormRecoverPassword()">Quên mật khẩu?</span>
                                                        <a href="javascript:void(0)" ng-click="showFormRegister()" class="btn-link-style btn-register" style="font-size: 16px; line-height: 24px; float: right;"
                            ...
                            <div class="page-login pagecustome clearfix">
                                <div class="wpx" style="margin-bottom: 0">
                                    ...
                                    <span class="block a-center dkm margin-top-10">Đã có tài khoản, đăng nhập <a
                                            href="javascript:void(0)" ng-click="showFormLogin()" class="btn-link-style btn-register" style="font-size: 16px; line-height: 24px; font-weight: 600;">tại
                                            đây</a></span>
                                    <div id="login" class="section">
