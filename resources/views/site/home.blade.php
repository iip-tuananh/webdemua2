            ...
            <div class="container">
                <div class="d-flex gap-3 section-top mb-3">
                            ...
                            @foreach ($productCategories as $category)
                                <a href="{{ route('front.show-product-category', $category->slug) }}"
                                    ...
                                    @if (isset($category->image))
                                        <img width="24" height="24" src="{{ $category->image->path ?? '' }}"
                                            alt="{{ $category->name }}" class="img-fluid object-fit-contain img-icon"
                                            loading="lazy">
                                        <img width="24" height="24" src="{{ $category->image->path ?? '' }}"
                                            alt="{{ $category->name }}" class="img-fluid object-fit-contain img-hover"
                                            loading="lazy">
                                    @else
                    ...
                    <div class="section-top-center">
                        ...
                        <div class="section-icon mt-3 p-3 bg-white d-flex justify-content-between text-center">
                            <div>
                                <img src="/site/images/chiet-khau-san-pham.svg" alt="Chiết khấu sản phẩm"
                            ...
                            <div>
                                <img src="/site/images/mua-si-gia-hoi.svg" alt="Mua sỉ giá hời" class="img-fluid mb-2"
                                    loading="lazy">
                                <div>
                                    Mua sỉ <br>
                                    giá hời
                            ...
                            <div>
                                <img src="/site/images/voucher-giam.svg" alt="Voucher giảm đến 200k" class="img-fluid mb-2"
                                    loading="lazy">
                                <div>
                                    Voucher giảm <br>
                                    đến 200k
                            ...
                            <div>
                                <img src="/site/images/qua-tang-hap-dan.svg" alt="Quà tặng hấp dẫn" class="img-fluid mb-2"
                                    loading="lazy">
                                <div>
                                    Quà tặng <br>
                                    hấp dẫn
                            ...
                            <div>
                                <img src="/site/images/chiet-khau-phi-van-chuyen.svg" alt="Chiết khấu phí vẫn chuyển"
                                    class="img-fluid mb-2" loading="lazy">
                                <div>
                                    Chiết khẩu <br>
                                    phí vẫn chuyển
                            ...
                            <div>
                                <img src="/site/images/flash-sale-gia-soc.svg" alt="Flash sale giá sốc"
                                    class="img-fluid mb-2" loading="lazy">
                                <div>
                                    Flash sale <br>
                                    giá sốc
                        ...
                        <div class="section-user mb-3">
                            <div class="section-user-top">
                                <div class="d-flex align-items-center gap-2 mb-3">
                                    <img src="/site/images/user-icon.jpg" alt="user" class="img-fluid"
                                        ng-if="!isAdminClient">
                                    <img src="{{ $user ? $user->image_avatar : '' }}" alt="admin" class="img-fluid"
                                        ng-if="isAdminClient">
                                    <div>
                                ...
                                <div class="d-flex align-items-center gap-2" ng-if="!isAdminClient">
                                    ...
                                    <a href="{{ route('front.login-client') }}?register=true"
                                        class="text-center p-2 btn-guest btn-register" title="Đăng ký">Đăng ký</a>
                                </div>
                                <div class="d-flex align-items-center gap-2" ng-if="isAdminClient">
                                    <a href="{{ route('front.logout-client') }}"
                                        class="text-center p-2 btn-guest btn-login" title="Đăng xuất">Đăng xuất</a>
                                </div>
                            </div>
                    ...
                    @if ($categorySpecialFlashsale)
                        <div class="bg-white section-item section-sale"
                            ...
                            <div class="section-title d-flex align-items-center justify-content-between">
                                <div
                                    onclick="window.location.href='{{ route('front.show-product-category', $categorySpecialFlashsale->slug) }}'">
                                                ...
                                                <a href="{{ route('front.show-product-detail', $product->slug) }}"
                                                    ...
                                                    <div class="position-relative item-image">
                                                        <img src="{{ $product->image->path ?? '' }}"
                                                            alt="{{ $product->name }}" class="img-fluid item-img"
                                                            loading="lazy">
                                                        <img src="{{ $product->image->path ?? '' }}"
                                                            alt="{{ $product->name }}" class="img-fluid img-gift"
                                                            loading="lazy">
                                                        @if ($product->base_price > 0)
                                                            <div class="item-discount position-absolute text-center"
                                                                style="top: 10px; left: 0; width: 50px; background: #fe2c55; color: #fff; padding: 2px 4px; border-top-right-radius: 25px; border-bottom-right-radius: 25px;">
                        ...
                        <div class="owl-carousel owl-theme" id="owl-tiktok">
                            @foreach ($reviews as $review)
                                ...
                                <div class="item-tiktok item-tiktok-134">
                                    <blockquote class="tiktok-embed" cite="{{ $review->message }}"
                                        data-video-id="{{ $data_id }}" style="max-width: 605px; min-width: 325px;">
                                        <section>Loading...</section>
                                    </blockquote>
                                    <div class="item-main">
                                        <a href="{{ $review->message }}" target="_blank" class="item-more">
                    ...
                    @if ($category->image)
                        <div class="section-banner d-flex align-items-center gap-3 mb-3">
                            <a href="{{ route('front.show-product-category', $category->slug) }}" title="banner 1">
                                <img class="img-fluid" alt="banner 1" src="{{ $category->image->path ?? '' }}"
                                    loading="lazy">
                            </a>
                        </div>
                    @endif
                    <div class="section-product bg-white mb-3">
                        <div class="mb-2 section-title" style="text-transform: capitalize;">{{ $category->name }}</div>
                ...
                <div class="section-slogan d-flex gap-3 align-items-center">
                    <div class="section-item bg-white d-flex align-items-center justify-content-center gap-3">
                        <img src="/site/images/san-pham-chinh-hang.svg" alt="Sản phẩm chính hãng" class="img-fluid">
                        <div class="text-uppercase">Sản phẩm <b>chính hãng</b></div>
                    </div>
                    <div class="section-item bg-white d-flex align-items-center justify-content-center gap-3">
                        <img src="/site/images/bao-hanh-1-1-toan-quoc.svg" alt="Bảo hành 1 đổi 1 toàn quốc"
                            class="img-fluid">
                        <div class="text-uppercase">Bảo hành 1 đổi 1 <b>toàn quốc</b></div>
                    </div>
                    <div class="section-item bg-white d-flex align-items-center justify-content-center gap-3">
                        <img src="/site/images/hotline-ho-tro.svg" alt="Hotline hỗ trợ {{ $config->hotline }}"
                            class="img-fluid">
                        <div class="text-uppercase">Hotline hỗ trợ <b>{{ $config->hotline }}</b></div>
                    </div>
                    <div class="section-item bg-white d-flex align-items-center justify-content-center gap-3">
                        <img src="/site/images/thu-tuc-doi-tra-de-dang.svg" alt="Thủ tục đổi trả dễ dàng"
                            class="img-fluid">
